...
void gpio_open(void){
  ...
  //USART Pins
  GPIO_PinModeSet(ICM_SENSOR_EN_PORT, ICM_SENSOR_EN_PIN, gpioModePushPull, true);
  GPIO_PinModeSet(ICM_CS_PORT,ICM_CS_PIN, gpioModePushPull, true);
  GPIO_PinModeSet(ICM_MISO_PORT,ICM_MISO_PIN, gpioModeInput, true);
  GPIO_PinModeSet(ICM_MOSI_PORT,ICM_MOSI_PIN, gpioModePushPull, true);
  GPIO_PinModeSet(ICM_CLK_PORT,ICM_CLK_PIN, gpioModePushPull, true);
}
