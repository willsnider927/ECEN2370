...
#define ICM_USART         USART3
#define ICM_MOSI_PORT     gpioPortC
#define ICM_MISO_PORT     gpioPortC
#define ICM_CS_PORT       gpioPortC
#define ICM_CLK_PORT      gpioPortC
#define ICM_MOSI_PIN      0
#define ICM_MISO_PIN      1
#define ICM_CS_PIN        3
#define ICM_CLK_PIN       2
#define ICM_MOSI_ROUTE    USART_ROUTELOC0_TXLOC_LOC18
#define ICM_MISO_ROUTE    USART_ROUTELOC0_RXLOC_LOC18
#define ICM_CS_ROUTE      USART_ROUTELOC0_CSLOC_LOC18
#define ICM_CLK_ROUTE     USART_ROUTELOC0_CLKLOC_LOC18
#define ICM_BAUD          7000000
#define ICM_CLOCK_MODE    usartClockMode3
#define ICM_DATABITS      usartDatabits8
#define ICM_REFFREQ       0
#define ICM_STOPBITS      usartStopbits1

#define ICM_SENSOR_EN_PORT gpioPortF
#define ICM_SENSOR_EN_PIN  8

#define PWRMGMT1_REG        0x06
#define PWRMGMT2_REG        0x07
#define LPCONFIG_REG        0x05
#define ACCEL_WOM_THR_REG   0x13
#define ICM_ZM_REG          0x31
#define ICM_ZL_REG          0x32
