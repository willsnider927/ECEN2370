 ...
 *
 * @details
 * initiates the read of the si1133 part id register
 *
 * @note
 * This function is application specific and can be changed depending on
 * needs of program
...
void scheduled_letimer0_comp1_cb(void)
{
  ...
  Si1133_read(SI1133_ID_REG, SI1133_LIGHT_READ_CB,1);
}
 ...
 *
 * @details
 *  turns on led color based on if the read of the part id register was successful
 *
 * @note
 * This function is application specific and can be changed depending on
 * needs of program
...
void scheduled_si1133_light_read_cb(void)
{
  ...
  uint32_t partID = si1133_pass_read();
  if (partID == SI1133_PARTID)
  {
